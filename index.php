<?php
	...
	require_once $_SERVER['DOCUMENT_ROOT'] . '/framework.local/project/config/connection.php';
	...
	spl_autoload_register(function($class) {
		...
		$path = $_SERVER['DOCUMENT_ROOT'] . '/framework.local' . DIRECTORY_SEPARATOR . $nameSpace . DIRECTORY_SEPARATOR . $className . '.php';
	...
	$routes = require $_SERVER['DOCUMENT_ROOT'] . '/framework.local/project/config/routes.php';
